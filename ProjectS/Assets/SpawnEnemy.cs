...
public class SpawnEnemy : MonoBehaviour
{
    ...
    public void spawn()
    {
        ...
        {
            for (int y = 0; y < (int)LvlPlayer.DefenceLvlOnScreen / 3; y++)
            {
        ...
        {
            for (int y = 0; y < (int)LvlPlayer.DefenceLvlOnScreen / 7; y++)
            {
        ...
        {
            for (int y = 0; y < (int)LvlPlayer.DefenceLvlOnScreen / 10; y++)
            {
